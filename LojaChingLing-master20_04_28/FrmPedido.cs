...
namespace LojaCL
{
    public partial class FrmPedido : Form
    {
        ...
        private void btnNovoItem_Click(object sender, EventArgs e)
        {
            if (botaoclicado == 1)
            {
                SqlCommand pedidos2 = new SqlCommand("InserirPedido", con);
                pedidos2.CommandType = CommandType.StoredProcedure;
                pedidos2.Parameters.AddWithValue("@Id_cartavenda", SqlDbType.Int).Value = cbxCartao.SelectedValue;
                ...
                Conexao.fecharConexao();
                MessageBox.Show("pedido atalizado", "atualizar pedido", MessageBoxButtons.OK, MessageBoxIcon.Information);
                botaoclicado = 0;
        ...
        private void cbxCartao_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Nenhum registro encontradoa!", "falha na Pesquisa", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Conexao.fecharConexao();
            }
        }
        ...
        private void btnAtualizar_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Pedido atualizado com suecesso", "Atualizar", MessageBoxButtons.OK, MessageBoxIcon.Information);
            cbxProduto.Text = "";
            txtQuantidade.Text = "";
            txtValor.Text = "";
            txtValorTotal.Text = "";
